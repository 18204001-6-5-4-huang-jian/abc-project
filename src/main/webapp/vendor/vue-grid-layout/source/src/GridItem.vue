...
//    var eventBus = require('./eventBus');
    ...
    export default {
        ...
        watch: {
            ...
            rowHeight: function() {
                this.createStyle('rowHeight');
            },
            cols: function() {
                this.createStyle('cols');
            },
            containerWidth: function(newVal, oldVal) {
                if (newVal != 0 && newVal != 100) {
                    this.createStyle('containerWidth');
                }
            },
            x: function() {
                this.createStyle('x');
        ...
        methods: {
            createStyle: function(from) {
                // console.log('createStyle', this.i, from);
